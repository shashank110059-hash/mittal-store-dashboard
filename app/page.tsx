...
export default function Home() {
  ...
  if (followed && !started) {
    return <FollowInstagram onContinue={() => setStarted(true)} />;
  }
  if (started) {
    return (
      <main className='min-h-screen bg-black text-white flex flex-col items-center px-6 pt-28 pb-10'>
        ...
        <h1 className='text-5xl font-bold text-white text-center'>How was your shopping experience?</h1>

        <p className='mt-4 text-gray-400 text-center'>Rate your shopping experience</p>
            ...
            <div className='mt-8 space-y-4'>
              {loading ? (
                <div className='text-center flex flex-col items-center'>
                  <img style={{height:'70px', width:'70px'}} className='animate-spin [animation-duration:5s]' src="/loader.png" alt="loader" />

                  <p className='mt-4 text-lg text-gray-400'>Preparing your perfect review...</p>
                </div>
              ) : (
            ...
            {selectedReview && (
              <div className='mt-10 flex flex-wrap justify-center gap-4'>
                ...
                <button
                  onClick={() => {
                    window.open(
                      'https://www.google.com/maps/place/Mittal+store/@28.6041674,77.1005099,14z/data=!4m12!1m2!2m1!1smittal+store!3m8!1s0x390d1b778c7bcf45:0x19040843a60f177d!8m2!3d28.6041674!4d77.1005099!9m1!1b1!15sCgxtaXR0YWwgc3RvcmVaDiIMbWl0dGFsIHN0b3JlkgEVcmVsaWdpb3VzX2dvb2RzX3N0b3JlmgEkQ2hkRFNVaE5NRzluUzBWSlEwRm5TVVIxYmw5TVNHdFJSUkFC4AEA-gEECAAQKg!16s%2Fg%2F11m32v3rwq?entry=ttu&g_ep=EgoyMDI2MDcxNS4wIKXMDSoASAFQAw%3D%3D',
                      '_blank',
                    );
                  }}
